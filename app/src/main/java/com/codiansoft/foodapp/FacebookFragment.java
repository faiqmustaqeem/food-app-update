...
public class FacebookFragment extends Fragment {
    ...
    private final String PENDING_ACTION_BUNDLE_KEY =
            "com.codiansoft.foodapp:PendingAction";
...
//                    .setPositiveButton(R.string.ok, null)
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //following code is now unnecessary
...
//            greeting.setText(getString(R.string.hello_user, profile.getFirstName()));
            greeting.setText(profile.getFirstName());
        } else {
//            Bitmap icon = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.user_default);
            Bitmap icon = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.fb_icon);
    ...
    private void postStatusUpdate() {
        ...
        ShareLinkContent linkContent = new ShareLinkContent.Builder()
                ...
                .setContentDescription(
                        "Integrate Facebook Login to your Android App")
                .setContentUrl(Uri.parse("http://www.codiansoft.com/"))
                .build();
...
//        Bitmap image = BitmapFactory.decodeResource(this.getResources(), R.drawable.androidlogo);
        Bitmap image = BitmapFactory.decodeResource(this.getResources(), R.drawable.fb_icon);
